...
import Image1 from "../../assets/Hero/toiletheroblock.jpg";
...
const ToiletBathroomhero = ({ handleOrderPopup }) => {
  return (
    <div className='md:max-w-[1400px] md:h-[780px] max-w-[1300px] h-[465px] w-full m-auto py-24 px-4 relative group '>
      ...
      <div className="flex items-center justify-center">
        <div className="text-center md:mt-0 mt-2 w-[900px]">
          ...
          TOILET AND BATHROOM INTERIOR DESIGNERS IN CHENNAI
          </h1>
        </div>
      </div>
    </div>
...
export default ToiletBathroomhero;

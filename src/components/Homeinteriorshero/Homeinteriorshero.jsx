...
import Image1 from "../../assets/Hero/homeintheroblock.jpg";
  ...
  return (
    <div className='md:max-w-[1400px] md:h-[780px] max-w-[1300px] h-[465px] w-full m-auto py-24 px-4 relative group '>
      ...
      >
        ...
        <div className="mx-auto justify-center item-center space-x-4 absolute bottom-[40px] md:bottom-[120px] left-1/2 transform -translate-x-1/2">
          <button
      ...
      <div className="flex items-center justify-center">
        <div className="text-center w-[900px]">
          <h1 className="text-3xl text-primary font-bold">
            HOME INTERIORS DESIGNERS IN CHENNAI
          </h1>
        </div>
      </div>
    </div>

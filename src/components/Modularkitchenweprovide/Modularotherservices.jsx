...
const Modularotherservices = () => {
  ...
  return (
    <div className="py-10 mb-10">
      ...
      <OrderPopup orderPopup={showOrderPopup} setOrderPopup={setShowOrderPopup} type={"Modular Services"} />
    </div>
  );
};

export default Modularotherservices;

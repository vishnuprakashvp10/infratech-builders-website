...
import Image1 from "../../assets/Hero/diningheroblock.jpg";
...
const Diningroomhero = ({ handleOrderPopup }) => {
  return (
    <div className='md:max-w-[1400px] md:h-[780px] max-w-[1300px] h-[465px] w-full m-auto py-24 px-4 relative group '>
      ...
      <div className="flex items-center justify-center">
        <div className="text-center w-[900px]">
          ...
          DINING ROOM INTERIOR DESIGNERS IN CHENNAI
          </h1>
        </div>
      </div>
    </div>
